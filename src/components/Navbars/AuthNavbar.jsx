...
{/* 
             ...
             <li className="flex items-center">
                <button
                  onClick={Logout}
                  className="bg-red-400 text-gray-200 active:bg-red-500 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150"
                  type="button"
                >
